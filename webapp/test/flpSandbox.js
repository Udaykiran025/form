		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commitform1applform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commitform1applform-display": {
								"semanticObject": "commitform1applform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mit.form1.appl.form",
									"url": sap.ui.require.toUrl("com/mit/form1/appl/form")
								}
							}
						}
					}
